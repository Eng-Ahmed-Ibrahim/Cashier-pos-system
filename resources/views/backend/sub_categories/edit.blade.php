...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('backend.admin.sub_categories.update', $subCategory->id) }}" method="post" class="accountForm"
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="image-upload-container" id="imageUploadContainer">
                                ...
                                <div class="thumb-preview" id="thumbPreviewContainer">
                                    <img src="{{ asset('storage/' . $subCategory->image) }}" alt="Thumbnail Preview"
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <textarea class="form-control" placeholder="Enter description" name="description">{{ old('description', $subCategory->description) }}</textarea>
                        </div>
                        <div class="mb-3 col-md-12">
                            <div class="form-switch px-4">
                                <input type="hidden" name="status" value="0">
                                <input class="form-check-input" type="checkbox" name="status" id="active" value="1"
                                    @if ($subCategory->status == 1) checked @endif>
