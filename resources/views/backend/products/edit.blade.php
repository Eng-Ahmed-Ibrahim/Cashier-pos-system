                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" class="form-control" placeholder="Enter  Barcode number" name="sku"
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control" placeholder="Stock"
...
@push('script')
    ...
    <script>
        ...
        function filterSubCategories() {
            ...
            let currentSubCategory = "{{ old('sub_category_id', $product->sub_category_id ?? '') }}";
            ...
            subCategories.forEach(function(item) {
                ...
                if (item.category_id == categoryId) {
                    ...
                    let selected = item.id == currentSubCategory ? 'selected' : '';
            ...
            $('#sub_category_id').html(options).trigger('change');
        }
